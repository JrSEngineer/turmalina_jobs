...
class JobVacancyModule extends Module {
  ...
  void binds(Injector i) {
    ...
    i.addLazySingleton<VacancyChatStore>(VacancyChatStore.new);
  }

  @override
  void routes(RouteManager r) {
    r.child('/:interessedUserId', child: (_) => const JobVacancyPage());
    r.child('/chat/:interessedUserId', child: (_) => const ChatPage());
